...
namespace PageModel
{
    ...
    {
        private static string LoginPageUrl = SeleniumConfig.GetWebSiteBase() + "Static/Training2/loginpage.html";
        ...
        public bool InvalidLogin(string username, string password)
        {
            this.txtUserName.SendKeys(username);
            this.txtPassword.SendSecretKeys(password);
            this.btnLogin.Click();
